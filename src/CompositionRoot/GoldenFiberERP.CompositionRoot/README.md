# GoldenFiberERP.CompositionRoot

## Overview

This project implements the **Composition Root** pattern for the GoldenFiberERP application. It serves as the single place where all dependencies across all layers are wired together, maintaining proper separation of concerns while enabling enterprise-scale dependency injection.
...
```
GoldenFiberERP.CompositionRoot/
├── GoldenFiberERP.CompositionRoot.csproj  # Project configuration
