# GoldenFiberERP.Application Layer

This is the Application layer of the GoldenFiberERP system, following Clean Architecture principles. This layer contains the application's use cases and business logic orchestration.
