namespace GoldenFiberERP.API.Configuration;
...
public class CookieSettings
{
    ...
    public string AccessTokenCookieName { get; set; } = "GoldenFiberERP.AccessToken";
    public string RefreshTokenCookieName { get; set; } = "GoldenFiberERP.RefreshToken";
    public int AccessTokenExpiryMinutes { get; set; } = 15;
    public int RefreshTokenExpiryDays { get; set; } = 7;
